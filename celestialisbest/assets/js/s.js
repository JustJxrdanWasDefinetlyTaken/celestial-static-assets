...
const presets = {
  ...
  nt: { title: "New Tab", favicon: "https://cdn.jsdelivr.net/gh/JustJxrdanWasDefinetlyTaken/celestial-static-assets@latest/celestialisbest/assets/img/newtab.png" },
};
...
function switchCloak() {
  if (document.hidden) {
    ...
    savedFavicon = document.getElementById("favicon")
      ...
      : "https://cdn.jsdelivr.net/gh/JustJxrdanWasDefinetlyTaken/celestial-static-assets@latest/celestialisbest/assets/img/logo.png";
    ...
    updateFavicon("https://cdn.jsdelivr.net/gh/JustJxrdanWasDefinetlyTaken/celestial-static-assets@latest/celestialisbest/assets/img/logo.png");
  }
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  toggle.onchange = function () {
    if (toggle.checked) {
      ...
      updateFavicon(
        localStorage.getItem("savedFavicon") || "https://cdn.jsdelivr.net/gh/JustJxrdanWasDefinetlyTaken/celestial-static-assets@latest/celestialisbest/assets/img/logo.png"
      );
    }
  };
});
